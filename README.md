...
### I. For no IDE, just plain editors

1. Install [Nodejs](https://nodejs.org/en/).

2. Clone this repository via Git or [Github Desktop](https://desktop.github.com/)
    ```
    git clone https://github.com/d-istratii/hci-project.git
    ```
